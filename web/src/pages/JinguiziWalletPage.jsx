      ...
      {enrollment && (
        <div className="trade-card p-6">
          ...
          <p className="text-xs text-gray-500 leading-relaxed mt-3">
            ...
            报名费(管理费)在6月结算时按盈利分档：盈利 ≥ 100% <strong className="text-gold">全额退还报名费</strong> + 奖励；盈利 10%~100% 仅<strong className="text-gold">全额退管理费</strong>(无奖励)；盈利 ≤ 10% 不退还。均为现金人工发放；
            两者<strong className="text-gold">均不自动入账</strong>，
